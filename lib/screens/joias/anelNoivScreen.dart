...
class anelNoivScreen extends StatefulWidget {
  ...
  @override
  State<anelNoivScreen> createState() => _anelNoivScreenState();
}

class _anelNoivScreenState extends State<anelNoivScreen> {

  int? count;
   int ProdutoQ = 0;
   String ProdutoID = '';
   String ProdutoN = 'Anel de Noivado';
   double ProdutoP = 0;
   String ProdutoE = '';
   double frete = 10.00;
  ...
  int bagValueanelNoiv = 0;

  int selectIndexanelNoiv = 0;

  int selectedIndexStarOanelNoiv = 0;

  int avlStarOanelNoiv = 0;

  List starOanelNoiv = List.generate(5, (index) => false);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: selectedIndexStarOanelNoiv,
        onTap: _onItemTapped,
                       ...
                       SizedBox(
                        ...
                        Padding(
                            ...
                            child: Container(
                              ...
                              width: 235,
                              color: Colors.blueAccent,
                              child: const Text('O interior é suavemente arredondado para um encaixe confortável, projetado para ser usado com facilidade ao longo dos anos.Esta aliança é um investimento que perdura, mantendo seu brilho e beleza ao longo dos anos, como testemunho do amor e compromisso eternos.',
                              textAlign: TextAlign.center,
                         ...
                         const SizedBox(
                          height: 5,
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(right: 0.0),
                                child: Text('${avlStarOanelNoiv + 1.0}',
                                  ...
                                  return Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: IconButton(
                                        onPressed:() {
                                          setState(() {
                                            selectedIndexStarOanelNoiv = index;
                                            starOanelNoiv[index] = !starOanelNoiv[index];
                                            for (int i = 0; i < starOanelNoiv.length; i++) {
                                                    starOanelNoiv[i] = i <= index;
                                                  }
                                          });
                                        }, icon: Icon(Icons.star,
                                        color: starOanelNoiv[index] ? Colors.yellow : Colors.grey,)),
                                    ),
                                  );
                                }),
                              ),
                              ...
                              FloatingActionButton.extended(
                                ...
                                onPressed: () {
                                  setState(() {
                                    avlStarOanelNoiv = selectedIndexStarOanelNoiv;
                                    showDialog(
                                      context: context,
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          ...
                                          textAlign: TextAlign.center,),
                                          content: Text('Sua avaliação foi: ${avlStarOanelNoiv + 1.0}',
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 15),),
