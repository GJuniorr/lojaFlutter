...
class colarCoracaoScreen extends StatefulWidget {
 final String? IDU;
  ...
  @override
  State<colarCoracaoScreen> createState() => _colarCoracaoScreenState();
}

class _colarCoracaoScreenState extends State<colarCoracaoScreen> {

  int? count;
   int ProdutoQ = 0;
   String ProdutoID = '';
   String ProdutoN = 'Colar Coração';
   double ProdutoP = 0;
   String ProdutoE = '';
   double frete = 10.00;
  ...
  int bagValuecolarCoracao = 0;

  int selectIndexcolarCoracao= 0;

  int selectedIndexStarOcolarCoracao = 0;

  int avlStarOcolarCoracao= 0;

  List starOcolarCoracao = List.generate(5, (index) => false);
                       ...
                       SizedBox(
                        ...
                        Padding(
                            ...
                            child: Container(
                              ...
                              width: 235,
                              color: Colors.blueAccent,
                              child: const Text('Este colar é delicadamente moldado no formato de um coração, evocando sentimentos de amor, romance e afeto.Fabricado com materiais de alta qualidade, como prata esterlina ou ouro 14 quilates, o colar oferece durabilidade e brilho duradouro.',
                              textAlign: TextAlign.center,
