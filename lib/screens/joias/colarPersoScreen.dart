...
class colarPersoScreen extends StatefulWidget {
    final String? IDU;
  ...
  @override
  State<colarPersoScreen> createState() => _colarPersoScreenState();
}

class _colarPersoScreenState extends State<colarPersoScreen> {

   int? count;
   int ProdutoQ = 0;
   String ProdutoID = '';
   String ProdutoN = 'Colar Personalizado';
   double ProdutoP = 0;
   String ProdutoE = '';
   double frete = 10.00;
  ...
  int bagValuecolarPerso = 0;

  int selectIndexcolarPerso= 0;

  int selectedIndexStarOcolarPerso = 0;

  int avlStarOcolarPerso= 0;

  List starOcolarPerso = List.generate(5, (index) => false);
                       ...
                       SizedBox(
                        ...
                        Padding(
                            ...
                            child: Container(
                              ...
                              width: 235,
                              color: Colors.blueAccent,
                              child: const Text('Este colar oferece uma ampla gama de opções de personalização, desde a escolha do estilo da corrente até a seleção de pingentes e adornos.A possibilidade de adicionar gravações personalizadas, como nomes, datas importantes ou mensagens significativas, torna este colar uma lembrança única e sentimental.',
                              textAlign: TextAlign.center,
