...
class colarPrataScreen extends StatefulWidget {
  final String? IDU;
  ...
  @override
  State<colarPrataScreen> createState() => _colarPrataScreenState();
}

class _colarPrataScreenState extends State<colarPrataScreen> {
  ...
  int bagValuecolarPrata = 0;

  int selectIndexcolarPrata= 0;

  int selectedIndexStarOcolarPrata = 0;

  int avlStarOcolarPrata= 0;

  List starOcolarPrata = List.generate(5, (index) => false);
                       ...
                       SizedBox(
                        ...
                        Padding(
                            ...
                            child: Container(
                              ...
                              width: 235,
                              color: Colors.blueAccent,
                              child: const Text('O colar apresenta um acabamento polido que realça o brilho natural da prata, proporcionando um visual elegante e sofisticado.Para manter o colar em ótimas condições, basta limpá-lo regularmente com um pano macio e armazená-lo em um local seco e protegido da umidade.',
                              textAlign: TextAlign.center,
