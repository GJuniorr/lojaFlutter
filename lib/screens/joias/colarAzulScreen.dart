...
class colarAzulScreen extends StatefulWidget {
  final String? IDU;
  ...
  @override
  State<colarAzulScreen> createState() => _colarAzulScreenState();
}

class _colarAzulScreenState extends State<colarAzulScreen> {

   int? count;
   int ProdutoQ = 0;
   String ProdutoID = '';
   String ProdutoN = 'Colar Azul';
   double ProdutoP = 0;
   String ProdutoE = '';
   double frete = 10.00;
  ...
  int bagValuecolarAzul = 0;

  int selectIndexcolarAzul= 0;

  int selectedIndexStarOcolarAzul = 0;

  int avlStarOcolarAzul= 0;

  List starOcolarAzul = List.generate(5, (index) => false);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: selectIndexcolarAzul,
        onTap: _onItemTapped,
                       ...
                       SizedBox(
                        ...
                        Padding(
                            ...
                            child: Container(
                              ...
                              width: 235,
                              color: Colors.blueAccent,
                              child: const Text('Colar feito de materiais como aço inoxidável ou titânio são altamente resistentes à corrosão, resistindo bem à exposição à umidade e substâncias químicas.Graças ao seu fecho ajustável, este colar se adapta confortavelmente a diferentes tamanhos de pescoço, proporcionando um ajuste seguro e personalizado.',
                              textAlign: TextAlign.center,
                                  ...
                                  return Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: IconButton(
                                        onPressed:() {
                                          setState(() {
                                            selectedIndexStarO = index;
                                            starO[index] = !starO[index];
                                            for (int i = 0; i < starO.length; i++) {
                                                    starO[i] = i <= index;
                                                  }
                                          });
                                        }, icon: Icon(Icons.star,
                                        color: starO[index] ? Colors.yellow : Colors.grey,)),
                                    ),
                                  );
                                }),
                              ),
                                    ...
                                    showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          ...
                                          textAlign: TextAlign.center,),
                                          content: Text('Sua avaliação foi: ${avlStarO + 1.0}',
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 15),),
