...
class AnOuroScreen extends StatefulWidget {
  ...
  @override
  State<AnOuroScreen> createState() => _AnOuroScreenState();
}

class _AnOuroScreenState extends State<AnOuroScreen> {
          ...
          child: Row(
              children: [
                 Padding(
                   ...
                   child: Column(
                     children: [
                       Image.asset('assets/images/alianOuro.png'),
                        Padding(
                            ...
                            child: Container(
                              ...
                              width: 235,
                              color: Colors.blueAccent,
                              child: const Text('Obra-prima da durabilidade,\n resiste ao teste do tempo\n e as aventuras da vida.\nCarrega um profundo simbolo\n de amor e compromisso eterno.',
                              textAlign: TextAlign.center,
