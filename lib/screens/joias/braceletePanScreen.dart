...
class braceletePanScreen extends StatefulWidget {
  ...
  @override
  State<braceletePanScreen> createState() => _braceletePanScreenState();
}

class _braceletePanScreenState extends State<braceletePanScreen> {

  int? count;
   int ProdutoQ = 0;
   String ProdutoID = '';
   String ProdutoN = 'Bracelete de Ouro';
   double ProdutoP = 0;
   String ProdutoE = '';
   double frete = 10.00;
  ...
  int bagValuebraceletePan = 0;

  int selectIndexbraceletePan = 0;

  int selectedIndexStarObraceletePan = 0;

  int avlStarObraceletePan= 0;

  List starObraceletePan = List.generate(5, (index) => false);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: selectIndexbraceletePan,
        onTap: _onItemTapped,
                       ...
                       SizedBox(
                        ...
                        Padding(
                            ...
                            child: Container(
                              ...
                              width: 235,
                              color: Colors.blueAccent,
                              child: const Text('Alta qualidade e o acabamento polido conferem ao bracelete um brilho radiante que atrai olhares e complementa qualquer estilo. Testes rigorosos de qualidade são realizados para garantir que o bracelete atenda aos mais altos padrões de durabilidade e resistência.',
                              textAlign: TextAlign.center,
                         ...
                         const SizedBox(
                          height: 12,
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(right: 0.0),
                                child: Text('${avlStarObraceletePan + 1.0}',
                                  ...
                                  return Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: IconButton(
                                        onPressed:() {
                                          setState(() {
                                            selectedIndexStarObraceletePan = index;
                                            starObraceletePan[index] = !starObraceletePan[index];
                                            for (int i = 0; i < starObraceletePan.length; i++) {
                                                    starObraceletePan[i] = i <= index;
                                                  }
                                          });
                                        }, icon: Icon(Icons.star,
                                        color: starObraceletePan[index] ? Colors.yellow : Colors.grey,)),
                                    ),
                                  );
                                }),
                              ),
                              ...
                              FloatingActionButton.extended(
                                ...
                                onPressed: () {
                                  setState(() {
                                    avlStarObraceletePan = selectedIndexStarObraceletePan;
                                    showDialog(
                                      context: context,
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          ...
                                          textAlign: TextAlign.center,),
                                          content: Text('Sua avaliação foi: ${avlStarObraceletePan + 1.0}',
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 15),),
