...
class colarOuroScreen extends StatefulWidget {
    final String? IDU;
  ...
  @override
  State<colarOuroScreen> createState() => _colarOuroScreenState();
}

class _colarOuroScreenState extends State<colarOuroScreen> {

  int? count;
   int ProdutoQ = 0;
   String ProdutoID = '';
   String ProdutoN = 'Colar de Ouro';
   double ProdutoP = 0;
   String ProdutoE = '';
   double frete = 10.00;
  ...
  int bagValuecolarOuro = 0;

  int selectIndexcolarOuro= 0;

  int selectedIndexStarOcolarOuro = 0;

  int avlStarOcolarOuro= 0;

  List starOcolarOuro = List.generate(5, (index) => false);
                       ...
                       SizedBox(
                        ...
                        Padding(
                            ...
                            child: Container(
                              ...
                              width: 235,
                              color: Colors.blueAccent,
                              child: const Text('O ouro é conhecido por seu brilho duradouro e capacidade de manter sua beleza ao longo do tempo, tornando os colares de ouro uma escolha clássica e atemporal. Este colar é versátil e pode ser usado tanto em ocasiões formais quanto em eventos casuais, adicionando um toque de glamour e sofisticação a qualquer conjunto.',
                              textAlign: TextAlign.center,
