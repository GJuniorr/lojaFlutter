...
class braceletePretoScreen extends StatefulWidget {
  ...
  @override
  State<braceletePretoScreen> createState() => _braceletePretoScreenState();
}

class _braceletePretoScreenState extends State<braceletePretoScreen> {

  int? count;
   int ProdutoQ = 0;
   String ProdutoID = '';
   String ProdutoN = 'Bracelete de Prata';
   double ProdutoP = 0;
   String ProdutoE = '';
   double frete = 10.00;
  ...
  int bagValuebraceletePreto = 0;

  int selectIndexbraceletePreto= 0;

  int selectedIndexStarObraceletePreto = 0;

  int avlStarObraceletePreto= 0;

  List starObraceletePreto = List.generate(5, (index) => false);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        currentIndex: selectIndexbraceletePreto,
        onTap: _onItemTapped,
                       ...
                       SizedBox(
                        ...
                        Padding(
                            ...
                            child: Container(
                              ...
                              width: 235,
                              color: Colors.blueAccent,
                              child: const Text('Projetado com atenção ao conforto, este bracelete apresenta bordas arredondadas e superfícies polidas para garantir um ajuste suave e agradável ao pulso.Este bracelete é tratado com revestimentos especiais para aumentar sua resistência a arranhões e desgaste, mantendo-os com uma aparência nova por mais tempo.',
                              textAlign: TextAlign.center,
                         ...
                         style: const TextStyle(
                          ...
                          color: Colors.lightGreenAccent
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(right: 0.0),
                                child: Text('${avlStarObraceletePreto + 1.0}',
                                  ...
                                  return Padding(
                                    ...
                                    child: SizedBox(
                                      ...
                                      child: IconButton(
                                        onPressed:() {
                                          setState(() {
                                            selectedIndexStarObraceletePreto = index;
                                            starObraceletePreto[index] = !starObraceletePreto[index];
                                            for (int i = 0; i < starObraceletePreto.length; i++) {
                                                    starObraceletePreto[i] = i <= index;
                                                  }
                                          });
                                        }, icon: Icon(Icons.star,
                                        color: starObraceletePreto[index] ? Colors.yellow : Colors.grey,)),
                                    ),
                                  );
                                }),
                              ),
                              ...
                              FloatingActionButton.extended(
                                ...
                                onPressed: () {
                                  setState(() {
                                    avlStarObraceletePreto = selectedIndexStarObraceletePreto;
                                    showDialog(
                                      context: context,
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          ...
                                          textAlign: TextAlign.center,),
                                          content: Text('Sua avaliação foi: ${avlStarObraceletePreto + 1.0}',
                                          textAlign: TextAlign.center,
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: 15),),
